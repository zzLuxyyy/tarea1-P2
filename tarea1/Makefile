...
ENTREGAR = fecha libro coleccion 
...
IDS_PUBLICOS = fecha1-crear-imprimir-liberar \
		       ...
		       fecha4-comparar \
		       fecha5-combinado \
		       libro1-crear-imprimir-liberar \
		       libro2-copiar \
	           coleccion1-crear-agregar-imprimir-liberar \
		       coleccion2-crear-agregar-imprimir-liberar \
		       coleccion3-esta-obtener \
		       coleccion4-existenLibrosFecha-imprimirLibrosGenero \
		       coleccion5-remover \
		       coleccion6-combinado
...
# incluye la clave de cada archivo en $(ARCHIVO_CLAVES)
$(ARCHIVO_CLAVES):
	rm -f $@
